...
@objc public protocol IMUIMessageMessageCollectionViewDelegate: NSObjectProtocol {
  ...
  @objc optional func messageCollectionView(didTapMessageBubbleInCell: UICollectionViewCell, model: IMUIMessageProtocol)
    ...
    /**
     *  Tells the delegate that user select message bubble
     */
    @objc optional func messageCollectionView(didSelectMessageBubbleInCell: UICollectionViewCell, model: IMUIMessageProtocol)
    
    /**
     *  Tells the delegate that user Deselect message bubble
     */
    @objc optional func messageCollectionView(didDeSelectMessageBubbleInCell: UICollectionViewCell, model: IMUIMessageProtocol)
