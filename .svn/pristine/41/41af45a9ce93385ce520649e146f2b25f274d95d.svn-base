...
//  EmakeServers
//
//  Created by 谷伟 on 2018/8/24.
//  Copyright © 2018年 谷伟. All rights reserved.
//

#import <Foundation/Foundation.h>

@interface YHItemModel : NSObject
...
@property (nonatomic,copy)NSString *TotalProductGroupPrice;
@property (nonatomic,copy)NSString *TotalShippingFee;
@end
