...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.font = [UIFont systemFontOfSize:AdaptFont(15)];
...
- (void)drawRect:(CGRect)rect {
    ...
    [self.placeholder drawInRect:CGRectMake(WidthRate(5), HeightRate(7), self.frame.size.width, self.frame.size.height) withAttributes:attrs];
}
