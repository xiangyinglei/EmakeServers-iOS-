...
open class IMUIMessageCellLayout: NSObject, IMUIMessageCellLayoutProtocol {
 ...
 public static let length = UIScreen.main.bounds.size.width*40/375
    public static let lengthAnother = UIScreen.main.bounds.size.width*16/375
  public static var avatarSize: CGSize = CGSize(width: length, height: length)
  public static var avatarOffsetToCell: UIOffset = UIOffset(horizontal: lengthAnother, vertical: UIScreen.main.bounds.size.width*16/667)
  
  public static var timeLabelFrame: CGRect = CGRect.zero
  
  public static var nameLabelSize: CGSize = CGSize(width: UIScreen.main.bounds.size.width*200/375, height: UIScreen.main.bounds.size.height*200/667)
  ...
  public static var bubbleMaxWidth: CGFloat = UIScreen.main.bounds.size.width*170/375
  ...
  public var relativeAvatarOffsetToCell: UIOffset {
    ...
    if self.isOutGoingMessage {
      if IMUIMessageCellLayout.isNeedShowOutGoingAvatar {
        return UIOffset(horizontal: -IMUIMessageCellLayout.avatarOffsetToCell.horizontal-changeWidth!, vertical: IMUIMessageCellLayout.avatarOffsetToCell.vertical)
      } else {
