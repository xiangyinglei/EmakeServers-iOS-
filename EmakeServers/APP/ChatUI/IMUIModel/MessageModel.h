...
- (instancetype)initWithText:(NSString *)text
           messageId:(NSString *)msgId messageUUID:(NSString *)UUID fromUser:(id <IMUIUserProtocol>)fromUser timeString:(NSString *)timeString isOutgoing:(BOOL)isOutGoing status:(IMUIMessageStatus) messageStatus;
//图片
- (instancetype)initWithImagePath:(NSString *) mediaPath
           messageId:(NSString *)msgId messageUUID:(NSString *)UUID
...
- (instancetype)initWithVideoPath:(NSString *) mediaPath
               ...
               isOutgoing:(BOOL)isOutGoing
                   status:(IMUIMessageStatus) messageStatus;
//合同
- (instancetype)initWithText:(NSString *)text ContractNo:(NSString *)ContractNo ContractImagePath:(NSString *)mediaPath ContractURL:(NSString *)url messageId:(NSString *)msgId messageUUID:(NSString *)UUID fromUser:(id<IMUIUserProtocol>)fromUser timeString:(NSString *)timeString isOutgoing:(BOOL)isOutGoing status:(IMUIMessageStatus)messageStatus;
//产品
- (instancetype)initWithProductJsonText:(NSString *)jsonText messageId:(NSString *)msgId messageUUID:(NSString *)UUID fromUser:(id<IMUIUserProtocol>)fromUser timeString:(NSString *)timeString isOutgoing:(BOOL)isOutGoing status:(IMUIMessageStatus)messageStatus;
//文件
- (instancetype)initWithFileText:(NSString *)fileText messageId:(NSString *)msgId messageUUID:(NSString *)UUID fromUser:(id<IMUIUserProtocol>)fromUser timeString:(NSString *)timeString isOutgoing:(BOOL)isOutGoing status:(IMUIMessageStatus)messageStatus;
@end
