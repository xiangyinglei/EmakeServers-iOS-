...
- (CGRect)bubbleFrame {
    CGRect bubbleAdjust = CGRectMake(_layout.bubbleFrame.origin.x-5,_layout.bubbleFrame.origin.y+15, _layout.bubbleFrame.size.width,  _layout.bubbleFrame.size.height);
    return bubbleAdjust;
}
...
- (CGRect)statusViewFrame {
    ...
    CGRect statusViewFrameAdjust = CGRectMake(_layout.statusViewFrame.origin.x,_layout.statusViewFrame.origin.y+13, _layout.statusViewFrame.size.width,  _layout.statusViewFrame.size.height);
    return statusViewFrameAdjust;
}

- (CGRect)nameLabelFrame {
    if (self.isOutgoing) {
        CGRect nameLabelFrameAdjust = CGRectMake(UIScreen.mainScreen.bounds.size.width-160,_layout.nameLabelFrame.origin.y-5, 80,  20);
