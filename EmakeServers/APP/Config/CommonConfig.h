...
#define NotificationStoreRefresh  @"NotificationStoreRefresh"
#define NotificationUserInfoRefresh  @"NotificationUserInfoRefresh"
...
//存储字段
#define LOGIN_TOKEN                             @"Emake_Token"
#define LOGIN_REFRESHTOKEN                      @"Emake_RefreshToken"
