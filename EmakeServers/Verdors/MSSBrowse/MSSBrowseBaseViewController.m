...
@property (nonatomic,strong)UILabel *countLabelName;// 当前图片位置
...
- (void)createBrowseView{
    ...
    _countLabelName = [[UILabel alloc]init];
    _countLabelName.textColor = [UIColor whiteColor];
    _countLabelName.frame = CGRectMake(0,23, _screenWidth, 50);
      MSSBrowseModel *browseItem =_browseItemArray[_currentIndex];
    _countLabelName.text =  browseItem.bigImageName;
    _countLabelName.textAlignment = NSTextAlignmentCenter;
    [_bgView addSubview:_countLabelName];
...
- (void)tap:(MSSBrowseCollectionViewCell *)browseCell
{
    ...
    [_countLabelName removeFromSuperview ];
    _countLabelName = nil;
    _countLabel = nil;
...
- (void)deviceOrientationDidChange:(NSNotification *)notification
{
    ...
    if(orientation == UIDeviceOrientationPortrait || orientation == UIDeviceOrientationLandscapeLeft || orientation == UIDeviceOrientationLandscapeRight)
    {
        ...
        _countLabel.frame = CGRectMake(0, _screenHeight - 50, _screenWidth, 50);
        _countLabelName.frame = CGRectMake(0, 25, ScreenWidth, 50);
